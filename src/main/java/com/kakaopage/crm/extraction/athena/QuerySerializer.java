...
public class QuerySerializer {
    ...
    static String serialize(Function function, StatementContext context) {
        ...
        if (function instanceof Some) {
            return String.format("some(%s)", serialize(((Some) function).getOf(), context));
        }
    ...
    static String serialize(Predicate condition, StatementContext context) {
        ...
        if (condition instanceof Equal) {
            ...
            return String.format("%s = %s", serialize(equal.firstOperand(), context), serialize(equal.secondOperand(), context));
        }
